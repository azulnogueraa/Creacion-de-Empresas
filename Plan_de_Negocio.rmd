...
Asignamos un presupuesto de 500 euros para la campaña. Aunque no se proporciona un dato específico para el CPM de Google Ads en España en los enlaces proporcionados, se puede inferir que el CPM en España para Google Ads podría estar en un rango similar al global, alrededor de 2.40 euros. El total de impresiones que podemos obtener se calcula de la siguiente manera:
...
Aunque los datos específicos para el sector educativo no están disponibles, es importante tener en cuenta que el conversion rate promedio para Instagram Ads se sitúa en aproximadamente el 1.08\% [^15]. Respecto al CTR para Instagram Ads, este se encuentra en el 0.52\% [^16]. De acuerdo con la información de Dinamiza Digital, el CPM promedio en España para Instagram Ads varía entre 1,97€ y 5,39€. Tomando un valor medio de 3,68€. El total de impresiones que podemos obtener se calcula de la siguiente manera:
...
Utilizando un CTR del 0.52\%, estimamos el número de clics que estas impresiones generarán:
...
Considerando una tasa de conversión promedio del 1.08\%, calculamos el número de conversiones esperadas de los usuarios que hicieron clic:

\[
\text{Conversiones Esperadas} = 706 \, \text{clics} \times \frac{1.08}{100} = 8 \, \text{conversiones}
\]

Este análisis proporciona una visión clara del impacto potencial de una inversión de 500 euros en una campaña de Instagram Ads dirigida al sector educativo.
...
![Necesidades Economicas](img/necesidad_economica.png){ width=50% }
...
![Presupuesto](img/presupuesto.png){ width=100% }
