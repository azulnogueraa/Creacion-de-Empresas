...
### 1.1. CNAE (Clasificación Nacional de Actividades Económicas)
...
**Detalle de ingreso de ventas**

El número de clientes obtenidos según el inciso 10.3, multiplicado por la métrica de recurrencia explicada en el apartado 9.2, resulta en una conversión anual de 11,220.

Basándonos en este número y considerando una retención anual del 100% y una tasa de recurrencia del 30% obtenida de la entrevista descrita en el apartado 3, calculamos la conversión total de cada año fiscal.

Multiplicando las conversiones anuales por el precio de cada suscripción, podemos determinar los ingresos de ventas anuales.
...
| **Conversión Total**          | 11,220   | 25,806   | 44,768   | 69,418   | 101,464  |
