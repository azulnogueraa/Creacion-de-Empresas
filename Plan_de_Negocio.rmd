...
![](img/años.png){ width=50% }

- ¿Estás actualmente estudiando?
  a. Si
  b. No
  
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/estudiando.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/nivel.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/dificultades.png){ width=70% }

- ¿Consideras que tus necesidades individuales de aprendizaje están siendo satisfechas?
  a. Si
  b. No
  
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/necesidades.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/IA.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/utilizado.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/terminar.png){ width=70% }
  
- Si tu respuesta no fue la Opcion 1,  ¿por que crees que no lograste terminar determinados cursos?

![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/porque.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/ratting.png){ width=70% }
  
- ¿Que caracteristicas buscas en una plataforma de educacion en linea?

![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/caracteristicas.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/interacción_IA.png){ width=70% }
...
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/precio.png){ width=70% }

- ¿Recomendarias la aplicacion?
  a. Si
  b. No
  
![Campos de estudio en los que se anticipa mayor crecimiento en los programas en línea](img/recomendación.png){ width=70% }
...
Según Wordstream, una cadena de marketing, la tasa de conversión promedio en Facebook Ads para el sector educativo se sitúa en torno al 13.58% [^11]. Este nivel de conversión refleja la capacidad de Facebook para atraer y comprometer a audiencias educativas, destacando su eficacia como un canal publicitario relevante para las instituciones educativas. Además, el CTR para Facebook Ads es del 0.73% [^11], lo que indica la proporción de usuarios que hacen clic en un anuncio después de verlo.

Al considerar estas métricas, se puede estimar el rendimiento de una campaña publicitaria en Facebook Ads. Según los datos proporcionados por Neo Attack, el CPM de una campaña en Facebook en España generalmente oscila entre 2 y 5€. Supongamos un CPM de 3€. Con un presupuesto de 500 euros, con este CPM se pueden alcanzar aproximadamente 166,666 visualizaciones del anuncio. Si mantenemos un CTR del 0.73%, se esperaría obtener alrededor de 1,217 clics en la publicidad. Considerando la tasa de conversión promedio del 13.58%, esto podría traducirse en aproximadamente 165 nuevos clientes generados a través de la campaña.

![La tasa de conversion de todas las industrias de Facebook Ads.](img/facebook.png){ width=80% }

**Google Ads**

En el caso de Google Ads, la tasa de conversión promedio para el sector educativo se sitúa alrededor del 5.93% para la búsqueda (Search) [^12]. Esta plataforma también muestra un rendimiento sólido en términos de conversion rates para las instituciones educativas que utilizan sus servicios publicitarios. El CTR para Google Ads es del 6.17% [^12], lo que indica una alta interacción de los usuarios con los anuncios en los resultados de búsqueda y en sitios web asociados.

Al considerar estas métricas, se puede estimar el rendimiento de una campaña publicitaria en Google Ads. Aunque no se proporciona un dato específico para el CPM de Google Ads en España en los enlaces proporcionados, se puede inferir que el CPM en España para Google Ads podría estar en un rango similar al global, alrededor de $2.40. Con un presupuesto de 500 euros y este CPM, se pueden alcanzar aproximadamente 208,333 visualizaciones del anuncio. Si mantenemos un CTR del 6.17%, se esperaría obtener alrededor de 12,843 clics en la publicidad. Considerando la tasa de conversión promedio del 5.93%, esto podría traducirse en aproximadamente 762 nuevos clientes generados a través de la campaña.

**Instagram Ads**

Aunque los datos específicos para el sector educativo no están disponibles, es importante tener en cuenta que el conversion rate promedio para Instagram Ads se sitúa en aproximadamente el 1.08% [^13]. Respecto al CTR para Instagram Ads, este se encuentra en el 0.52% [^14].

Al considerar estas métricas, se puede estimar el rendimiento de una campaña publicitaria en Instagram Ads. De acuerdo con la información de Dinamiza Digital, el CPM promedio en España para Instagram Ads varía entre 1,97€ y 5,39€. Tomando un valor medio de 3,68€. Con un presupuesto de 500 euros y este CPM, se pueden alcanzar aproximadamente 135,870 visualizaciones del anuncio. Suponiendo un CTR del 0.52%, se esperaría obtener alrededor de 706 clics en la publicidad. Considerando la tasa de conversión promedio del 1.08%, esto podría traducirse en aproximadamente 8 nuevos clientes generados a través de la campaña.
...
En resumen, al considerar las estimaciones de clientes generados a través de las campañas publicitarias en Facebook Ads, Instagram Ads y Google Ads, se proyecta un total de 935 nuevos clientes potenciales.
...
[^12]: FUENTE: [2022 Google Ads & Microsoft Ads Benchmarks for Every Industry.](https://www.wordstream.com/blog/ws/2022/05/18/search-advertising-benchmarks)

[^13]: FUENTE: [Instagram Ads: ¿Cómo crearlos en 2023 para convertir?](https://visme.co/blog/es/instagram-ads/)

[^14]: FUENTE: [Instagram Analytics](https://lorenzo-gonzalez.com/instagram-analytics-las-9-metricas-mas-importantes-para-medir-tu-exito/#:~:text=Tasas%20de%20clics%20de%20anuncios%20(CTR),-El%20objetivo%20principal&text=Las%20tasas%20de%20clics%20promedio,%2C52%25%2Cseg%C3%BAn%20Adstage.)
