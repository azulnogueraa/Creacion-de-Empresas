...
Según los datos proporcionados por Neo Attack [^4], el CPM de una campaña en Facebook en España generalmente oscila entre 2 y 5€. 

**Instagram Ads**

De acuerdo con la información de Dinamiza Digital [^5], el CPM promedio en España para Instagram Ads varía entre 1,97€ y 5,39€.
...
[^4]: FUENTE: [¿Cuánto cuesta Facebook Ads?](https://neoattack.com/blog/cuanto-cuesta-facebook-ads/#:~:text=tipo%20de%20empresas.-,Cu%C3%A1nto%20cuesta%20Facebook%20Ads%20en%20Espa%C3%B1a,entre%200.5%20y%203%E2%82%AC.)

[^5]: FUENTE: [Cuánto cuesta la publicidad en Instagram en España?](https://dinamizadigital.com/cuanto-cuesta-la-publicidad-en-instagram/)

### 10.3. Estimacion de personas atraidas por la promocion

En el sector educativo, las tasas de conversión en plataformas publicitarias clave como Facebook Ads, Google Ads e Instagram Ads pueden ofrecer una visión valiosa sobre la efectividad de nuestras campañas.

**Facebook Ads**

Según Wordstream, una cadena de marketing, la tasa de conversión promedio en Facebook Ads para el sector educativo se sitúa en torno al 13.58% [^6]. Este nivel de conversión refleja la capacidad de Facebook para atraer y comprometer a audiencias educativas, destacando su eficacia como un canal publicitario relevante para las instituciones educativas.

![La tasa de conversion de todas las industrias de Facebook Ads.](img/facebook.png){ width=100% }

**Google Ads**

En el caso de Google Ads, las tasas de conversión promedio para el sector educativo se sitúan alrededor del 3.39% para la búsqueda (Search) y 0.50% para la red de display (Display) [^7]. Estos números demuestran el sólido desempeño de Google Ads en términos de tasas de conversión para las instituciones educativas, tanto en la red de búsqueda como en la de display.

**Instagram Ads**

Para Instagram Ads, la tasa de conversión promedio en el sector educativo se estima en aproximadamente el 1.08% [^8]. Aunque esta tasa es más baja en comparación con otras plataformas, Instagram sigue siendo un canal relevante para la promoción de servicios educativos, especialmente entre audiencias más jóvenes.

**Estimación de Conversion Rate Final**

Al promediar las tasas de conversión de Facebook Ads (13.58%), Google Ads (3.89%) e Instagram Ads (1.08%) para el sector educativo, obtenemos una estimación de la tasa de conversión final de aproximadamente el 6.18%. Esta cifra combinada ofrece una visión general de la posible efectividad de nuestras campañas publicitarias en estas plataformas para promocionar servicios educativos.
...
[^6]: FUENTE: [Facebook Ad Benchmarks for YOUR Industry.](https://www.wordstream.com/blog/ws/2017/02/28/facebook-advertising-benchmarks)

[^7]: FUENTE: [Benchmarks de Google Ads para tu industria.](https://www.linkedin.com/pulse/benchmarks-de-google-ads-para-tu-industria-pedro-cerrilla/)

[^8]: FUENTE: [Instagram Ads: ¿Cómo crearlos en 2023 para convertir?](https://visme.co/blog/es/instagram-ads/)
\newpage
